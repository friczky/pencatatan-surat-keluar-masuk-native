...
if(isset($_GET['bulan'])){
    $bulan  = $_GET['bulan'];
    $tahun  = $_GET['tahun'];
    $sql_waktu = "SELECT * FROM format_surat where bulan='$bulan' and tahun='$tahun' and jenis_surat='0' ";
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <?php 
                        if(isset($_GET['bulan'])){
                            echo '<a href="cetak_surat_masuk.php?bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'" class="btn btn-primary">
